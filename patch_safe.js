...
const themeIndex = css.indexOf('/* ================= TEMA VIENS ================= */');
if (themeIndex !== -1) {
  // Strip out the old basic theme block entirely
  css = css.substring(0, themeIndex);
}

const advancedTheme = `/* ================= TEMA VIENS ================= */
body.theme-viens {
  --bg-color: #090514;
...
console.log('Advanced Viens theme overrides applied SAFELY!');
